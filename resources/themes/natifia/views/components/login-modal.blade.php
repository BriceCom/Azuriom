        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="monFormulaire" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row align-items-end justify-content-between gap-4 gap-md-0 mt-4 mt-md-0">
                        <div class="col-md-8 d-flex flex-column flex-md-row align-items-end align-items-md-start gap-1 gap-md-3">
