...
<footer class="text-center text-white bg-dark mt-auto py-4">
    <div class="copyright">
        <div class="container">
            <p>{{ setting('copyright') }} | <span title="Version {{$version_theme['version']}}">{{trans('theme::theme.footer.copyright')}} <a href="https://discord.gg/4SbjuXYFzd" target="_blank" rel="noopener noreferrer">Brice#6204</a>.</span> | @lang('messages.copyright') </p>
