<div class="hero z-0 position-relative d-flex align-items-center justify-content-center py-5 pt-md-10">
            ...
            <nav class="collapse navbar-collapse py-4 py-md-0" id="navbar">
                ...
                <ul class="nav-join navbar-nav flex-row align-items-center justify-content-center text-center text-md-end ml-auto mt-3 mt-md-0 align-items-center gap-2">
                    ...
                    <li class="nav-item dropdown d-flex" data-animate="navlink-anime">
                        <a class="fw-bold text-uppercase text-uppercase dropdown-toggle text-md text-decoration-none text-decoration-none"
                   ...
                   @foreach(theme_config('header.hero.carousel') as $carousel)
                       @if($carousel)
                           <div class="carousel-item @if($loop->first) active @endif">
                               <img src="{{image_url($carousel)}}" class="d-block w-100" alt="...">
                           </div>
                       @endif
                   @endforeach
               @endif
