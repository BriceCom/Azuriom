<div class="h-100 d-flex flex-column">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-3">
        ...
        <span class="discord-list_count text-white-50 text-xs fw-semibold ms-auto">{online} en ligne</span>
    </div>
    <div class="discord-list-wrapper">
        <ul class="discord-list list-unstyled my-3 px-2">
        </ul>
    </div>
    <div class="d-flex justify-content-between align-items-center px-2 fs-6 mt-4">
        <a class="btn btn-primary text-sm text-uppercase" href="{{theme_config('home.discord.url') ?? 'https://discord.gg/Gh2ddyBxUWvV'}}" rel="noopener" target="_blank">Nous rejoindre</a>
    </div>
</div>
