window.addEventListener("DOMContentLoaded", (event) => {
    ...
    let formAzuriom = document.getElementById('configForm')
    formAzuriom.addEventListener('submit', function (event) {
        ...
        document.querySelectorAll('.js-detect-create-builder-input').forEach(function (el) {
            let copy = el.querySelector('.js-detect-create-builder-copy').firstElementChild
    ...
    document.querySelectorAll('.js-detect-create-builder-input-add').forEach(function (event) {
        event.addEventListener('click', function (click) {
            let copy = event.closest('.js-detect-create-builder-input').querySelector('.js-detect-create-builder-copy')

            let wrapper = event.closest('.js-detect-create-builder-input').querySelector('.inputs_wrapper')
