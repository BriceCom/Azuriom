<div class="p-2 d-flex flex-column gap-5">
    ...
    <fieldset class="d-flex flex-column gap-3 border p-2 w-100">
        ...
        <div class="d-flex flex-wrap gap-3">
            @include('admin.components.forms.color', ['name' => trans('theme::admin.style.colors.primary'), 'id' => $id.'[light][primary]', 'value' => '#34CABC'])
            @include('admin.components.forms.color', ['name' => trans('theme::admin.style.colors.secondary'), 'id' => $id.'[light][secondary]', 'value' => '#9e9e9e'])
            @include('admin.components.forms.color', ['name' => trans('theme::admin.style.colors.tertiary'), 'id' => $id.'[light][tertiary]', 'value' => '#f8f8    f8'])
            @include('admin.components.forms.color', ['name' => trans('theme::admin.style.colors.quaternary'), 'id' => $id.'[light][quaternary]', 'value' => '#a779d7'])
        </div>
...
{{--            @include('admin.components.forms.color', ['name' => trans('theme::admin.style.colors.quaternary'), 'id' => $id.'[dark][quaternary]', 'value' => '#9344e7'])--}}
{{--        </div>--}}
