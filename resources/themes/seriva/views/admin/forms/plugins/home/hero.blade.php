<x-admin.card :title="trans('theme::admin.menus.home.hero')">
    ...
    @include('admin.components.forms.text', ['name' => trans('theme::admin.form.badge'), 'id' => $id.'[badge]'])
    ...
    <x-admin.fieldset :title="trans('theme::admin.form.floating_cards')">
        @include('admin.components.forms.text', ['name' => trans('theme::admin.form.float_review'), 'id' => $id.'[float_review]'])
        @include('admin.components.forms.text', ['name' => trans('theme::admin.form.float_score_label'), 'id' => $id.'[float_score_label]'])
        @include('admin.components.forms.text', ['name' => trans('theme::admin.form.float_score_value'), 'id' => $id.'[float_score_value]'])
    </x-admin.fieldset>
</x-admin.card>
