...
:root {
    ...
    [data-bs-theme=light]{
        ...
        --di-dark-rgb: {{hexToRGB(theme_config('style.colors.light.dark')??'#000000')}};
        --di-dark-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.dark')??'#000000'))}};
