...
<head>
    ...
    <meta name="author" content="{{site_name()}}, Dixept">
    <meta name="publisher" content="{{site_name()}}, Dixept">
    <meta name="description" content="@yield('description', setting('description', ''))">
    <meta name="keywords" content="Serveur minecraft gratuit {{site_name()}}, {{site_name()}} server, Serveur francais Minecraft {{site_name()}}">
