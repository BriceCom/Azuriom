...
@php
    ...
    $homeSections = collect([
        ...
        [
            'key' => 'textbuttonimage',
            'order' => $resolveHomeOrder('home.textbuttonimage.order', 45),
            'position' => 5,
            'enabled' => !theme_config('home.textbuttonimage.off'),
        ],
        [
            'key' => 'changelog',
               ...
               <div class="@if($showSidebar) col-lg-9 @endif">
                   <div class="d-flex flex-column gap-5">
                       @foreach($homeSections as $section)
                           ...
                           @elseif($section['key'] === 'textbuttonimage')
                               @include('components.text-button-image')
