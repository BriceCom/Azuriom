...
:root {
    --di-main-gap: {{ theme_config('home.index.gap') ?? 248 }}px;
    ...
    [data-bs-theme=light],[data-bs-theme=dark]{
        ...
        --di-border-radius-pill: {{ theme_config('style.ui.btnRadius') ?  theme_config('style.ui.btnRadius')."px" : "inherit"}};
    ...
    [data-bs-theme=light]{
        ...
        --di-primary-rgb: {{hexToRGB(theme_config('style.colors.light.primary')??'#facd36')}};
        --di-primary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.primary')??'#facd36'))}};
        --di-primary-hsl: {{hexToHSL(theme_config('style.colors.light.primary')??'#facd36')}};
        --di-primary-text-emphasis: #000000;

        --di-secondary: rgba(var(--di-secondary-rgb), 1);
        --di-secondary-rgb: {{hexToRGB(theme_config('style.colors.light.secondary')??'#dedede')}};
        --di-secondary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.secondary')??'#dedede'))}};
        --di-secondary-hsl: {{hexToHSL(theme_config('style.colors.light.secondary')??'#dedede')}};
        ...
        --di-quaternary-rgb: {{hexToRGB(theme_config('style.colors.light.quaternary')??'#ECAF2D')}};
        --di-quaternary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.quaternary')??'#ECAF2D'))}};
        ...
        --di-dark-rgb: {{hexToRGB(theme_config('style.colors.light.dark')??'#f5f5f5')}};
        --di-dark-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.dark')??'#f5f5f5'))}};
    ...
    [data-bs-theme=dark]{
        /* Colors */
        --di-primary: rgba(var(--di-primary-rgb), 1);
        --di-primary-rgb: {{hexToRGB(theme_config('style.colors.dark.primary')??'#facd36')}};
        --di-primary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.dark.primary')??'#facd36'))}};
        --di-primary-hsl: {{hexToHSL(theme_config('style.colors.dark.primary')??'#facd36')}};
        --di-primary-text-emphasis: #000000;

        --di-secondary: rgba(var(--di-secondary-rgb), 1);
        --di-secondary-rgb: {{hexToRGB(theme_config('style.colors.dark.secondary')??'#dedede')}};
        --di-secondary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.dark.secondary')??'#dedede'))}};
        --di-secondary-hsl: {{hexToHSL(theme_config('style.colors.dark.secondary')??'#dedede')}};
        --di-secondary-text-emphasis: #000000;
        ...
        --di-quaternary: rgba(var(--di-quaternary-rgb), 1);
        --di-quaternary-rgb: {{hexToRGB(theme_config('style.colors.dark.quaternary')??'#ECAF2D')}};
        --di-quaternary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.dark.quaternary')??'#ECAF2D'))}};
        --di-quaternary-hsl: {{hexToHSL(theme_config('style.colors.dark.quaternary')??'#ECAF2D')}};

        /* Bg color */
        --di-light: rgba(var(--di-light-rgb), 1);
        --di-light-rgb: {{hexToRGB(theme_config('style.colors.dark.light')??'#FFFFFF')}};
        ...
        --di-black: rgba(var(--di-black-rgb), 1);
        --di-black-rgb: {{hexToRGB(theme_config('style.colors.dark.black')??'#070606')}};

        --di-tertiary-bg: rgba(var(--di-black-rgb), 1);
        --di-secondary-bg-rgb: var(--di-light-rgb);

        --di-body-bg: rgba(var(--di-body-rgb), 1);
        --di-body-rgb: {{hexToRGB(theme_config('style.colors.dark.body')??'#111111')}};
