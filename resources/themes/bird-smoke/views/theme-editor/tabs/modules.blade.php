<section>
    @component('theme-editor.components.accordion', ['title' => 'Barre d’annonce', 'open' => true, 'class' => 'te-module te-module-advanced'])
        <div class="te-advanced-hint" data-te-advanced-hint>
            ...
            <p class="te-advanced-hint-text mb-2">
                Vous pouvez configurer ce module, mais il ne sera appliqué qu’en mode avancé.
            </p>
    ...
    @component('theme-editor.components.accordion', ['title' => 'Barre de progression (scroll)', 'open' => true, 'class' => 'te-module te-module-advanced'])
        <div class="te-advanced-hint" data-te-advanced-hint>
            <p class="te-advanced-hint-title mb-1">Comment activer le mode avancé</p>
            <p class="te-advanced-hint-text mb-2">
                Vous pouvez configurer ce module, mais il ne sera appliqué qu’en mode avancé.
        ...
        <label class="te-field">
            <span class="te-field-label">Hauteur (2-20)</span>
            <input type="number" class="te-input" data-key="modules.scroll_progress.height" min="2" max="20">
        </label>

        <label class="te-field">
            <span class="te-field-label">Couleur de fond</span>
        ...
        <label class="te-field">
            <span class="te-field-label">Couleur de progression</span>
