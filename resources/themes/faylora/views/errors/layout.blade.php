            ...
            <div class="mx-auto max-w-2xl bg-steel-200 rounded-2xl">
                <div
                    ...
                    <div class="flex justify-center items-center w-auto overflow-hidden gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-white h-6 w-6" viewBox="0 0 512 512">
                            <path
                        ...
                        <div class="w-full text-ellipsis truncate">
                            <h4 class="text-white font-medium truncate md:text-sm text-xs">@yield('title')</h4>
                        </div>
                    </div>
                </div>
                <div class="p-8 flex flex-col text-white text-center">
                    <h1 class="text-2xl font-semibold">@yield('code')</h1>
                    <p class="text-sm">@yield('message')</p>
                    <a href="{{ route('home') }}"
                        class="w-64 py-4 px-5 inline-flex justify-center items-center gap-2 rounded-xl bg-primary text-white font-semibold transition-all text-xs truncate mx-auto mt-8">
                        {{ trans('errors.home') }}
                    </a>
                </div>
            </div>
