...
<head>
    ...
    <link rel="preload" href="{{ theme_asset('css/override_bootstrap.css').'?ver='.$version_theme }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ theme_asset('css/override_bootstrap.css').'?ver='.$version_theme }}"></noscript>
    <link rel="preload" href="{{ theme_asset('css/styles.css').'?ver='.$version_theme }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ theme_asset('css/styles.css').'?ver='.$version_theme }}"></noscript>
    @stack('styles')
    <style>
