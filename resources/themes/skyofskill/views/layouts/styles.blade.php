...
:root {
    ...
    [data-bs-theme=light]{
        ...
        --di-primary-rgb: {{color_rgb(theme_config('style.colors.light.primary')??'#C9FF6B')}};
        --di-primary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.light.primary')??'#C9FF6B'))}};
        --di-primary-hsl: {{hexToHSL(theme_config('style.colors.light.primary')??'#C9FF6B')}};
        --di-primary-text-emphasis: #000000;

        --di-secondary: rgba(var(--di-secondary-rgb), 1);
        --di-secondary-rgb: {{color_rgb(theme_config('style.colors.light.secondary')??'#55C3F9')}};
        --di-secondary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.light.secondary')??'#55C3F9'))}};
        --di-secondary-hsl: {{hexToHSL(theme_config('style.colors.light.secondary')??'#55C3F9')}};
        --di-secondary-text-emphasis: #000000;

        --di-tertiary: rgba(var(--di-tertiary-rgb), 1);
        --di-tertiary-rgb: {{color_rgb(theme_config('style.colors.light.tertiary')??'#FED955')}};
        --di-tertiary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.light.tertiary')??'#FED955'))}};
        --di-tertiary-hsl: {{hexToHSL(theme_config('style.colors.light.tertiary')??'#FED955')}};

        --di-quaternary: rgba(var(--di-quaternary-rgb), 1);
        --di-quaternary-rgb: {{color_rgb(theme_config('style.colors.light.quaternary')??'#F278F9')}};
        --di-quaternary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.light.quaternary')??'#F278F9'))}};
        --di-quaternary-hsl: {{hexToHSL(theme_config('style.colors.light.quaternary')??'#F278F9')}};
        ...
        --di-dark-rgb: {{color_rgb(theme_config('style.colors.light.dark')??'#ffffff')}};
        --di-dark-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.light.dark')??'#ffffff'))}};
        ...
        --di-body-rgb: {{color_rgb(theme_config('style.colors.light.body')??'#F8F7F5')}};
        ...
        --di-emphasis-color: {{theme_config('style.colors.light.light')??'#f2f2f2'}};
    ...
    [data-bs-theme=dark]{
        /* Colors */
        --di-primary: rgba(var(--di-primary-rgb), 1);
        --di-primary-rgb: {{color_rgb(theme_config('style.colors.dark.primary')??'#00B7FF')}};
        --di-primary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.dark.primary')??'#00B7FF'))}};
        --di-primary-hsl: {{hexToHSL(theme_config('style.colors.dark.primary')??'#00B7FF')}};
        --di-primary-text-emphasis: {{ color_contrast(theme_config('style.colors.dark.primary') ??'#00B7FF') }};

        --di-secondary: rgba(var(--di-secondary-rgb), 1);
        --di-secondary-rgb: {{color_rgb(theme_config('style.colors.dark.secondary')??'#55C3F9')}};
        --di-secondary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.dark.secondary')??'#55C3F9'))}};
        --di-secondary-hsl: {{hexToHSL(theme_config('style.colors.dark.secondary')??'#55C3F9')}};
        --di-secondary-text-emphasis: {{ color_contrast(theme_config('style.colors.dark.secondary') ??'#55C3F9') }};


        --di-tertiary: rgba(var(--di-tertiary-rgb), 1);
        --di-tertiary-rgb: {{color_rgb(theme_config('style.colors.dark.tertiary')??'#FED955')}};
        --di-tertiary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.dark.tertiary')??'#FED955'))}};
        --di-tertiary-hsl: {{hexToHSL(theme_config('style.colors.dark.tertiary')??'#FED955')}};
        --di-tertiary-text-emphasis: {{ color_contrast(theme_config('style.colors.dark.tertiary') ??'#FED955') }};

        --di-quaternary: rgba(var(--di-quaternary-rgb), 1);
        --di-quaternary-rgb: {{color_rgb(theme_config('style.colors.dark.quaternary')??'#F278F9')}};
        --di-quaternary-rgb-no_commas: {{RGBnocommas(color_rgb(theme_config('style.colors.dark.quaternary')??'#F278F9'))}};
        --di-quaternary-hsl: {{hexToHSL(theme_config('style.colors.dark.quaternary')??'#F278F9')}};
        --di-quaternary-text-emphasis: {{ color_contrast(theme_config('style.colors.dark.quaternary') ??'#F278F9') }};
        ...
        --di-body-color: var(--di-white);
        --di-nav-link-color: var(--di-body-color);
        --di-emphasis-color: {{theme_config('style.colors.dark.light')??'#6c757d'}};
        ...
        --di-warning: {{theme_config('style.colors.dark.warning') ?? '#F88934' }};
        --di-warning-hex: {{theme_config('style.colors.dark.warning') ?? '#F88934' }};
        --di-warning-rgb: {{color_rgb(theme_config('style.colors.dark.warning')??'#F88934')}};
        --di-warning-hsl: {{hexToHSL(theme_config('style.colors.dark.warning')??'#F88934')}};

        --di-danger: {{theme_config('style.colors.dark.danger') ?? '#F83434' }};
        --di-danger-hex: {{theme_config('style.colors.dark.danger') ?? '#F83434' }};
        --di-danger-rgb: {{color_rgb(theme_config('style.colors.dark.danger')??'#F83434')}};
        --di-danger-hsl: {{hexToHSL(theme_config('style.colors.dark.danger')??'#F83434')}};
    }
}
</style>
