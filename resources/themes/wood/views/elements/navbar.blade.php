<section class="z-0 position-relative d-flex align-items-center justify-content-center py-5 header-bg">
    ...
    <div class="position-absolute top-0 end-0 pt-4 pe-8">
        <div class="d-flex align-items-center gap-4">
            <ul class="list-unstyled d-flex align-items-center gap-2.5 mb-0">
                @include('elements.theme-selector')
                @guest
                    <ul class="list-unstyled d-flex align-items-center gap-3 mb-0 bg-body p-2.5 rounded ms-2">
                    <li class="nav-item">
    ...
    <div class="container text-center">
        <a href="{{ route('home') }}">
            <img src="{{ site_logo() }}" alt="Logo {{ site_name() }}" class="mb-4" height="{{theme_config('header.index.hero.img.height') ?? 235}}" draggable="false" >
        </a>

        <div class="w-fit d-flex flex-column align-items-end gap-1 mx-auto" data-editable="true">
...
<header class="z-10 position-sticky top-0 navbar navbar-expand-md bg-body-secondary py-3 border-bottom border-2 border-white border-opacity-10">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <ul class="navbar-nav text-center text-md-end ml-auto mt-3 mt-md-0">
