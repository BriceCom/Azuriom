...
<div class="form-group">
    ...
    <textarea type="textaera" class="form-control @error('event-box-paragraph') is-invalid @enderror" id="event-box-paragraph" name={{ $id }}" aria-describedby="{{ $idReplace }}">{{ old($idReplace, config('theme.'.str_replace(['[', ']'],['.',''],$id))) }}</textarea>
    @error($id)
