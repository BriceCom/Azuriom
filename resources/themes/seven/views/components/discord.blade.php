<section class="discord card container py-4 px-3 px-md-8">
    <div class="row d-flex flex-wrap gap-3 justify-content-between">
        <div class="col-md-4 discord__img">
            <img height="{{theme_config('home.discord.imgHeight') ?? "170"}}"
                 src="{{theme_config('home.discord.img') ? image_url(theme_config('home.discord.img')): "https://dummyimage.com/200x200/3D3635/aa"}}"
                 alt="">
        </div>
        <div class='col-md-7 discord__content d-flex flex-column gap-1'>
            ...
            <div class="text-md-end">
                <a href="{{theme_config('home.discord.link.url') ?? "#"}}"
                   class="w-fit btn btn-secondary text-uppercase">{{theme_config('home.discord.link.text') ?? "Join discord"}}
