        ...
        $menus = [
            ...
            'home' => [
                ...
                'multiple_page' => [
                    ...
                    'hero' =>['name'=> trans('theme::admin.menus.home.hero')],
                    'support' =>['name'=> trans('theme::admin.menus.home.support')],
                    'results' =>['name'=> trans('theme::admin.menus.home.results')],
                    'blog' =>['name'=> trans('theme::admin.menus.home.blog')],
                ]
            ],
            'sidebar' => [
...
@section('content')
    ...
    @include('components.admin.partials.intro', ['ressourceName' => 'seriva', 'ressourceType' => 'theme'])
