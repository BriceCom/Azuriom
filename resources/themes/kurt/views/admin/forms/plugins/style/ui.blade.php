<div class="p-2 d-flex flex-column gap-3">
    ...
    <div class="d-flex flex-wrap gap-3">
        ...
        <fieldset class="d-flex flex-column gap-3 border p-2 w-50">
            <legend class="float-none w-auto p-2 py-0 bg-dark text-white text-lg">{{trans('theme::admin.style.ui.btnRadius.name')}}</legend>
            @include('admin.components.forms.range', ['name' => trans('theme::admin.pixel'), 'id' => $id.'[btnRadius]', 'value' => 8,'max' => 64, 'min' => 0, 'step' => 2])
