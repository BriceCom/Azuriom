<fieldset class="d-flex gap-3 border p-2 w-100">
    ...
    <fieldset class="d-flex flex-column gap-3 border p-2 w-100">
        ...
        <div class="form-group">
            ...
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorLight-primary" name="general[colorLight][primary]" type="color" class="form-control form-control-color @error('general-colorLight-primary') is-invalid @enderror" value="{{ old('general-colorLight-primary', config('theme.general.colorLight.primary')) ?? '#000000' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#000000" onclick="inputColorDefaultValue(this, '#000000', '{{config('theme.general.colorLight.primary')}}')"/>
        ...
        <div class="form-group">
            ...
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorLight-secondary" name="general[colorLight][secondary]" type="color" class="form-control form-control-color @error('general-colorLight-secondary') is-invalid @enderror" value="{{ old('general-colorLight-secondary', config('theme.general.colorLight.secondary')) ?? '#DDFDE8' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#DDFDE8" onclick="inputColorDefaultValue(this, '#DDFDE8', '{{config('theme.general.colorLight.secondary')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
        ...
        <div class="form-group">
            <label for="general-colorLight-tertiary" class="form-label fw-bold m-0 mt-2">{{trans('theme::admin.color')}} {{trans('theme::admin.tertiary')}}</label>
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorLight-tertiary" name="general[colorLight][tertiary]" type="color" class="form-control form-control-color @error('general-colorLight-tertiary') is-invalid @enderror" value="{{ old('general-colorLight-tertiary', config('theme.general.colorLight.tertiary')) ?? '#ffda79' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#ffda79" onclick="inputColorDefaultValue(this, '#ffda79', '{{config('theme.general.colorLight.tertiary')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
            @error('general-colorLight-tertiary')
            <small class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></small>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorLight-body" name="general[colorLight][body]" type="color" class="form-control form-control-color @error('general-colorLight-body') is-invalid @enderror" value="{{ old('general-colorLight-body', config('theme.general.colorLight.body')) ?? '#ffffff' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#ffffff" onclick="inputColorDefaultValue(this, '#ffffff', '{{config('theme.general.colorLight.body')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
    ...
    <fieldset class="d-flex flex-column gap-3 border p-2 w-100">
        ...
        <div class="form-group">
            <label for="general-colorLight-texttertiary" class="form-label fw-bold m-0 mt-2">{{trans('theme::admin.form.colors.color_of_texttertiary_buttons')}}</label>
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorLight-texttertiary" name="general[colorLight][texttertiary]" type="color" class="form-control form-control-color @error('general-colorLight-texttertiary') is-invalid @enderror" value="{{ old('general-colorLight-texttertiary', config('theme.general.colorLight.texttertiary')) ?? '#000000' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#000000" onclick="inputColorDefaultValue(this, '#000000', '{{config('theme.general.colorLight.texttertiary')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
            @error('general-colorLight-texttertiary')
            <small class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></small>
            @enderror
        </div>
    </fieldset>
...
<fieldset class="d-flex gap-3 border p-2 w-100">
    ...
    <fieldset class="d-flex flex-column gap-3 border p-2 w-100">
        ...
        <div class="form-group">
            ...
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorDark-secondary" name="general[colorDark][secondary]" type="color" class="form-control form-control-color @error('general-colorDark-secondary') is-invalid @enderror" value="{{ old('general-colorDark-secondary', config('theme.general.colorDark.secondary')) ?? '#114f16' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#114f16" onclick="inputColorDefaultValue(this, '#114f16', '{{config('theme.general.colorDark.secondary')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
        ...
        <div class="form-group">
            <label for="general-colorDark-tertiary" class="form-label fw-bold m-0 mt-2">{{trans('theme::admin.color')}} {{trans('theme::admin.tertiary')}}</label>
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorDark-tertiary" name="general[colorDark][tertiary]" type="color" class="form-control form-control-color @error('general-colorDark-tertiary') is-invalid @enderror" value="{{ old('general-colorDark-tertiary', config('theme.general.colorDark.tertiary')) ?? '#f7e2a3' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#f7e2a3" onclick="inputColorDefaultValue(this, '#f7e2a3', '{{config('theme.general.colorDark.tertiary')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
            @error('general-colorDark-tertiary')
            <small class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></small>
            @enderror
        </div>
    ...
    <fieldset class="d-flex flex-column gap-3 border p-2 w-100">
        ...
        <div class="form-group">
            <label for="general-colorDark-texttertiary" class="form-label fw-bold m-0 mt-2">{{trans('theme::admin.form.colors.color_of_texttertiary_buttons')}}</label>
            <div class="d-flex flex-row align-items-center gap-1">
                <input id="general-colorDark-texttertiary" name="general[colorDark][texttertiary]" type="color" class="form-control form-control-color @error('general-colorDark-texttertiary') is-invalid @enderror" value="{{ old('general-colorDark-texttertiary', config('theme.general.colorDark.texttertiary')) ?? '#5d4d1d' }}">
                <input type="checkbox" class="colorPicker fst-italic" value="#5d4d1d" onclick="inputColorDefaultValue(this, '#5d4d1d', '{{config('theme.general.colorDark.texttertiary')}}')"/>
                <small>{{trans('theme::admin.form.color.default_color')}}</small>
            </div>
            @error('general-colorDark-texttertiary')
            <small class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></small>
            @enderror
        </div>
    </fieldset>
