...
<main class="h-full -mt-20 pt-10 px-8 overflow-x-hidden">
    <div class="container mx-auto grid grid-cols-12">
        ...
        <div class="w-full col-span-12 xl:col-span-9 xl:pl-10 mt-8 lg:mt-0">
            @if(session('success'))
            ...
            <div class="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8">
                <a href="/shop" class="h-20 w-full bg-steel-100 rounded-2xl group flex">
                    <div
                        class="relative flex flex-col justify-center items-center group-hover:w-full w-56 h-full group-hover:scale-125 group-hover:animate-float transition-all duration-200 ">
                        <img class="z-10 absolute h-20 w-20 group-hover:w-28 group-hover:h-28 top-4 group-hover:top-0 transition-all duration-200 overflow-hidden"
                            src="{{ theme_asset('img/chest.png') }}">
                        <div
                            class="z-0 absolute h-12 w-12 group-hover:w-20 group-hover:h-20 bg-[#eed24f] top-5 blur-xl inset-0 mx-auto">
                        </div>
                    </div>
                    <div class="w-full bg-steel-200 rounded-2xl flex justify-center items-center group-hover:bg-primary transition ease-in-out duration-200"
                        data-ripple-dark="true">
                        <div class="flex flex-col text-left mx-auto px-4">
                            <p class="text-xl text-white font-semibold text-left">
                                Boutique
                            </p>
                            <p class="mt-0.5 text-xs text-white font-semibold uppercase">
                                CLIQUE POUR ACCEDER
                            </p>
                        </div>
                    </div>
                </a>
                <a href="/vote" class="h-20 w-full bg-steel-100 rounded-2xl group flex">
                    <div
                        class="relative flex flex-col justify-center items-center group-hover:w-full w-56 h-full group-hover:scale-125 group-hover:animate-float transition-all duration-200 ">
                        <img class="z-10 absolute h-20 w-20 group-hover:w-28 group-hover:h-28 top-4 group-hover:top-0 transition-all duration-200 "
                            src="{{ theme_asset('img/fish.png') }}">
                        <div
                            class="z-0 absolute h-12 w-12 group-hover:w-20 group-hover:h-20 bg-[#b1dfed] top-5 blur-xl inset-0 mx-auto">
                        </div>
                    </div>
                    <div class="w-full bg-steel-200 rounded-2xl flex justify-center items-center group-hover:bg-primary transition ease-in-out duration-200 overflow-hidden"
                        data-ripple-dark="true">
                        <div class="flex flex-col text-left mx-auto px-4">
                            <p class="text-xl text-white font-semibold text-left">
                                Voter
                ...
                <a href="https://discord.gg/faylora" class="h-20 w-full bg-steel-100 rounded-2xl group hidden lg:flex">
                    <div
                        class="relative flex flex-col justify-center items-center group-hover:w-full w-56 h-full group-hover:scale-125 group-hover:animate-float transition-all duration-200 ">
                        <img class="z-10 absolute h-20 w-20 group-hover:w-28 group-hover:h-28 top-4 group-hover:top-0 transition-all duration-200 "
                            src="{{ theme_asset('img/gem.png') }}">
                        <div
                            class="z-0 absolute h-12 w-12 group-hover:w-20 group-hover:h-20 bg-[#24cd5c] top-5 blur-xl inset-0 mx-auto">
                        </div>
                    </div>
                    <div class="w-full bg-steel-200 rounded-2xl flex justify-center items-center group-hover:bg-primary transition ease-in-out duration-200 overflow-hidden"
                        data-ripple-dark="true">
            ...
            <div class="bg-steel-400 mt-10 rounded-2xl">
                <div
