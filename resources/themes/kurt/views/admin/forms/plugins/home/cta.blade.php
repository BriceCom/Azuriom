<div class="d-flex flex-column gap-4">
    ...
    <fieldset class="d-flex flex-column gap-3 border p-2 w-100">
        <legend class="float-none w-auto p-2 py-0 bg-dark text-white text-lg">{{ trans('theme::admin.menus.home.cta') }}</legend>
        <div class="d-flex flex-column gap-2">
            ...
            @include('admin.components.forms.textaera', ['name' => trans('theme::admin.form.text'), 'id' => $id.'[text]',  "wysiwyg" => true, "height" => 200])
