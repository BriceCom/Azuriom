...
<x-admin.card :title="trans('theme::admin.background')">
            <p>{{ trans('theme::admin.background_help') }}
                <a href="http://127.0.0.1:8000/admin/settings#imageSelect" target="_blank">{{ trans('theme::admin.azuriom_settings') }}</a>.</p>
...
<x-admin.card :title="trans('theme::admin.font.title')" :advanced="true">
...
{{--    TODO: Next version    --}}
{{--        <x-admin.fieldset :title="trans('theme::admin.secondary_font_example_for_tile')" class="d-flex gap-3">--}}
{{--            @include('admin.components.forms.url', [--}}
{{--                'id' => $id.'[font_title][url]',--}}
{{--                'nameToUpper' => false,--}}
