    ...
    >
        ...
        <div class="hero__bottom">
            <div class="container d-flex justify-content-between">
                ...
                <a href="https://dixept.fr/discord" target="_blank" class="hero__content text-black text-decoration-none d-flex flex-column align-items-end">
                    @php
                        $url = theme_config('settings.discord.link') ?? 'https://www.dixept.fr/discord';
                        $modifiedUrl = str_replace("https://www.", "", $url);
                    @endphp
                    <span class="fw-bold text-uppercase">{{$modifiedUrl}}</span>
                    <span class="discord-list_count d-inline-flex px-1 text-xs fw-semibold bg-tertiary bg-opacity-50 border border-1 border-tertiary border-tertiary rounded-pill px-2">{online} connectés</span>
                </a>
            </div>
        </div>
    </div>
