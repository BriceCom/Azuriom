...
class TebexHomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $sidebarModules = $this->getSidebarModules($token);

        return view('tebex::index', [
    ...
    private function getSidebarModules(string $token): array
    {
        $response = $this->tebexApi->getSidebarModules($token);
