...
<div class="row gx-3">
    <div class="mb-3 col-md-6">
        ...
        {{-- Alternaive-coins fork --}}
        <div class="mb-3">
             <label class="form-label" for="alternativeCoin">Prix en monnaie alternative</label>
                <div
                    id="alternativeCoin"
                    class="input-group @error('alternative_price') has-validation @enderror">
                    <input type="number" min="0" step="0.01" max="999999" class="form-control @error('alternative_price') is-invalid @enderror" name="alternative_price" value="{{ old('alternative_price', $package->alternative_price) }}" required>
                    <span class="input-group-text">{{ $coins->name }}</span>

                    @error('alternative_price')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
        </div>
