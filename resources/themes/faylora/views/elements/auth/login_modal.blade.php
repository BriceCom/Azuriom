            ...
            <div
                ...
                <div class="order-1 flex flex-col gap-8 justify-center">
                    <div class="flex flex-col">
                        <h1 class="text-white font-semibold text-xl">{{ trans('auth.login') }}</h1>
                        <div class="h-1 w-16 bg-steel-200 rounded-full mt-1"></div>
                    </div>
                    <form action="{{ route('login') }}" method="POST" class="bg-steel-300 flex flex-col gap-8">
                        @csrf
                        ...
                        <div class="relative bg-inherit">
                            <input type="password" id="password" name="password" minlength="1" maxlength="128"
                        ...
                        <a class="text-steel-50 hover:text-white font-medium text-sm justify-center items-center flex transition duration-300 cursor-pointer"
                            data-hs-overlay="#lost_password_modal">{{ trans('auth.forgot_password') }}</a>
                        @endif
                    </form>
                </div>
            </div>
