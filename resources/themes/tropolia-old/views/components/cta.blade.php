...
<section class="container">
            <div class="row gx-4.5 gy-4">
                ...
                <div class="col-lg-6" data-editable="true">
                    ...
                    @else
                        <p class="opacity-75 mb-4">Lrem Ipsum is simply dummy text of the printing and typesetting industry. m Ipsum is simpm Ipsum is sm Ipsum is simpLrem Ipsum is simply dummy text of the printing and typesetting industry. m Ipsum is simpm Ipsum is sm Ipsum is simp</p>
                    @endif
