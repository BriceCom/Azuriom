...
<main class="h-full -mt-20 pt-10 px-8 overflow-x-hidden">
    <div class="container mx-auto grid grid-cols-12">
        ...
        <div class="w-full col-span-12">
            <div class="bg-steel-100 rounded-2xl mt-10">
                ...
                <div class="p-8 space-y-6">
                    <div class="flex flex-col">
                        <span class="text-white font-semibold md:text-2xl text-lg truncate">{{
                            trans('shop::messages.offers.gateway') }}</span>
                    ...
                    <div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                        ...
                        <a class="group flex flex-col bg-steel-300 shadow-sm rounded-xl hover:shadow-md transition h-20"
                            href="{{ route('shop.offers.buy', $gateway) }}" data-ripple-dark="true">
                            <div class="p-4 md:p-5 my-auto">
                                <div class="flex justify-between items-center">
                                    <img src="{{ $gateway->paymentMethod()->image() }}" class="md:h-8 h-5"
                                        style="filter: brightness(0) invert(1);" alt="{{ $gateway->name }}">
                                    <div class="pl-3">
