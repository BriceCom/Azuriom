...
@if(count($paramDefinitions) === 0)
    <p class="te-help mb-0">{{ $te('modal.no_params', 'Aucun paramètre éditable pour ce bloc.') }}</p>
@else
            ...
            @if($type === 'list')
                <div class="{{ $wrapperClass }}">
                    ...
                    >
                        ...
                        <button type="button" class="te-btn te-btn-success te-list-add" data-list-add>{{ $te('common.new_item', 'Nouveau +') }}</button>
                    </div>
                </div>
            ...
            @elseif($type === 'image')
                <label class="{{ $wrapperClass }}">
                    ...
                    <select class="te-input" data-block-param="{{ $key }}" data-block-type="image" data-te-image-select="true">
                        <option value="">{{ $te('common.no_image', 'Aucune image') }}</option>
