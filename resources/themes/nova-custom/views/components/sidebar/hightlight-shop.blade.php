@if(!theme_config('sidebar.article.off'))
    @if(plugins()->isEnabled('shop'))
        <div class="home-sideblock home-sideblock-shop">
            <h2 class="h3 mb-3">{{ theme_config('sidebar.article.title') ?? trans('theme::theme.highlight_article') }}</h2>
            ...
            <a href="{{ route('shop.home') }}" class="btn btn-tertiary w-100">{{ trans('shop::messages.title') }}</a>
        </div>
    @endif
@endif
