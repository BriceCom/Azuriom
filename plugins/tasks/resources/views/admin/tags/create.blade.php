...
@section('title', trans('tasks::admin.tags.create'))

@section('content')
    <div class="card shadow mb-4">
        <div class="card-header">
            <h6 class="m-0 font-weight-bold text-primary">{{ trans('tasks::admin.tags.create') }}</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('tasks.admin.tags.store') }}" method="POST">
                @csrf
