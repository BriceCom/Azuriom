...
class TebexServiceProvider extends BasePluginServiceProvider
{
    ...
    {
        // Register the TebexApiService as a singleton
        $this->app->singleton(TebexApiService::class, function ($app) {
            return new TebexApiService();
        });

        // Register the TebexShopService, which depends on TebexApiService
        $this->app->singleton(TebexShopService::class, function ($app) {
            return new TebexShopService($app->make(TebexApiService::class));
        });
    }
