...
@section('content')
    <h1>{{ theme_config('faq.hero.title') ?? trans('faq::messages.title') }}</h1>
    <p class="w-75 opacity-75 mx-auto text-center">{{ theme_config('faq.hero.subtitle') ?? "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation." }}</p>
