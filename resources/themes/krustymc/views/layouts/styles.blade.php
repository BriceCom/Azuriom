...
:root {
    ...
    [data-bs-theme=light]{
        ...
        --di-primary-rgb: {{hexToRGB(theme_config('style.colors.light.primary')??'#34CABC')}};
        --di-primary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.primary')??'#34CABC'))}};
        --di-primary-hsl: {{hexToHSL(theme_config('style.colors.light.primary')??'#34CABC')}};

        --di-secondary: rgba(var(--di-secondary-rgb), 1);
        --di-secondary-rgb: {{hexToRGB(theme_config('style.colors.light.secondary')??'#9e9e9e')}};
        --di-secondary-rgb-no_commas: {{RGBnocommas(hexToRGB(theme_config('style.colors.light.secondary')??'#9e9e9e'))}};
        --di-secondary-hsl: {{hexToHSL(theme_config('style.colors.light.secondary')??'#9e9e9e')}};
