...
<head>
    ...
    @stack('styles')
    <style>
            @import url({{theme_config('style.index.font.url') ?? 'https://fonts.bunny.net/css?family=paytone-one:400&display=swap'}});
            @import url('https://fonts.bunny.net/css?family=poppins:200,300,400,500,600,700,800&display=swap');
            @import url(https://fonts.bunny.net/css?family=single-day:400&display=swap);
            @import url(https://fonts.bunny.net/css?family=vt323:400);

        :root {
            --di-main-font: "{{theme_config('style.index.font.name') ?? 'paytone one'}}", sans-serif;
            --di-second-font: "poppins", sans-serif;
            --di-tertiary-font: "single day", sans-serif;
            --di-quaterny-font: "vt323", sans-serif;
            --di-minecraft-font: "Minecraft", sans-serif;
        }
    </style>
...
<div id="app">
    ...
    <div class="d-flex flex-column overflow-x-hidden text-dark">
        @yield('app')
...
<script src="{{ theme_asset('js/interactive-cubes.js') }}"></script>
