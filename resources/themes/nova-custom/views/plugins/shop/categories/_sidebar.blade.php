@if($shopUser !== null)
    <div class="d-grid gap-2 mb-4">
        ...
        <div class="d-flex gap-2.5 align-items-center">
            <img src={{Auth::user()->getAvatar(64)}} class="rounded-2" alt="Avatar" width="48" height="48">
            <div class="d-flex flex-column">
                <span class="text-white">{{Auth::user()->name}}</span>
                @if(use_site_money())
                    <span class="badge text-bg-tertiary text-tertiary border"  style="--di-badge-color: var(--di-tertiary)">
        ...
        @if($userHasPayments)
            <a href="{{ route('shop.profile') }}" class="btn btn-outline-primary btn-block mt-3">
        ...
        <div class="row g-2">
            <div  class="col-md-6"  >
                <a href="{{ route('shop.cart.index') }}" class="w-100 btn btn-outline-tertiary btn-block">
            ...
            @if(use_site_money())
                <div class="col-md-6">
                    <a href="{{ route('shop.offers.select') }}" class="w-100 btn btn-outline-primary btn-block">
