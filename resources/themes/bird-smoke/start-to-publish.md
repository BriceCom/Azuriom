...
- [ ] Detacher les blocs de demo propres a Bird du coeur generic quand ils ne sont pas utiles ailleurs.
...
- [ ] Ajouter le drag-and-drop pour le page builder.
- [ ] Ajouter undo/redo.
- [ ] Ajouter import/export de presets JSON.
- [ ] Externaliser tous les labels statiques de l'UI en i18n.
