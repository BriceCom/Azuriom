<li class="nav-item dropdown notifications-dropdown btn btn-outline-secondary text-white bg-dark bg-opacity-10">
    <a class="nav-link dropdown-toggle p-0" href="#" id="notificationsDropdown" role="button" data-bs-toggle="dropdown"
