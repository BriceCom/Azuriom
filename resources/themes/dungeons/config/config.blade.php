        ...
        <form class="w-100" action="{{ route('admin.themes.config', $theme) }}" method="POST">
            ...
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">GENERAL</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.general', ['id'=> 'general'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                ...
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.navbar', ['id'=> 'navbar'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
            ...
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">VOTER</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
            ...
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">MON PROFIL</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.profile', ['id'=> 'profile'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">BOUTIQUE</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.shop', ['id'=> 'shop'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">MES ACHATS</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.purchases', ['id'=> 'purchases'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">PANIER</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.cart', ['id'=> 'cart'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
                    <h2 class="fw-bold fs-3 m-0 text-uppercase">OFFRES</h2>
                </div>
                <div class="card-body d-flex flex-column flex-md-row gap-3">
                    @includeIf('admin.offers', ['id'=> 'offers'])
                </div>
            </div>
            <div class="card bg-secondary bg-opacity-10">
                <div class="card-header bg-secondary bg-opacity-25">
