    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <ul class="navbar-nav align-items-lg-center ml-md-auto gap-3 mt-3 mt-lg-0">
                ...
                <a href="{{theme_config('header.btn.url') ?? '/shop'}}" class="w-fit d-inline-block mt-3 mt-md-0 nav-item btn btn-primary btn-gradient rounded-pill border-3 border-primary-subtle px-5 py-2 fw-semibold text-uppercase text-sm my-4 my-md-0">
                    {{theme_config('header.btn.text') ?? 'Boutique'}}
                </a>
