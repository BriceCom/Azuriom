        ...
        @if(!theme_config('header.hero.discord.hide'))
            <a class="btn d-flex align-items-center gap-3 text-start" href="{{theme_config('settings.discord.link') ?? "https://discord.gg/ZdSPkxK5xT"}}" target="_blank">
                ...
                <div class="text-uppercase fw-semibold" data-editable="true">
                    ...
                    <span class="text-sm">{{theme_config('header.hero.discord.text') ?? trans('theme::theme.join_community')}}</span>
                </div>
            </a>
        @endif
    </div>
                        ...
                        @foreach($navbar as $element)
                            @if(!$element->isDropdown())
                                <li class="nav-item" data-animate="navlink-anime">
                                    <a class="text-lg ff-main text-uppercase btn @if($element->value === "shop.home" || $element->value === "tebex.index") btn-outline-{{ theme_config('header.index.links.shop_variant') ?? 'tertiary' }} @else border-0 nav-link @endif d-flex align-items-center gap-2.5 @if($element->isCurrent()) active bg-opacity-10 @endif"
                            ...
                            @else
                                <li class="nav-item dropdown d-flex align-items-center gap-2.5" data-animate="navlink-anime">
                                    <a class="text-lg ff-main text-uppercase btn dropdown-toggle @if($element->isCurrent()) active bg-opacity-10 @endif"
