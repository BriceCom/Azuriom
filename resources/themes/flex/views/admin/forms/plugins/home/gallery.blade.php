<x-admin.card :title="trans('theme::admin.menus.home.gallery')">
    @if(!plugins()->isEnabled('gallery'))
        <div class="alert alert-warning">
            Activez le plugin Gallery pour afficher la section Gallery sur la page d'accueil.
        </div>
    @endif
