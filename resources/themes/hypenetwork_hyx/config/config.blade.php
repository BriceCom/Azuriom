...
@php
    $menus = [
        'home' => [
            'not_a_plugin' => true,
            'is_enabled' => true,
            'multiple_page' => ['index' =>['name'=> trans('theme::admin.menus.home.index')],
...
@endphp
@section('content')
    <p>Maquette par <a href="https://itsme.to/" target="_blank">Théo</a>, thème par <a href="https://dixept.fr/" target="_blank">Bricec6</a> pour <b>HypeNetwork</b></p>
